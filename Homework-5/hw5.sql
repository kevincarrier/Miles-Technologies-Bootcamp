/*
	Kevin Carrier	10/8/2020
	Miles Technologies Bootcamp - Homework 5
*/
...
AS   
RETURN(
	SELECT DISTINCT r.RoomName as 'Room Name', t.Name as 'Tavern Name', s.Rate FROM Rooms r JOIN Taverns t ON r.TavernID = t.ID JOIN RoomStays s ON s.RoomID = r.ID
